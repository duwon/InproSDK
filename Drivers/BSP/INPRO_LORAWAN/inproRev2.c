...
/** @addtogroup INRPO_LORAWAN_REV2_LOW_LEVEL 
  ...
  *        available on INRPO_LORAWAN_REV2 Discovery Kit from STMicroelectronics.
  * @{
  */ 

/** @defgroup INRPO_LORAWAN_REV2_LOW_LEVEL_Private_TypesDefinitions 
  * @{
  */ 
/**
  * @}
...
/** @defgroup INRPO_LORAWAN_REV2_LOW_LEVEL_Private_Defines 
  * @{
  */ 
...
/** @defgroup INRPO_LORAWAN_REV2_LOW_LEVEL_Private_Variables
  * @{
  */ 
...
/** @defgroup INRPO_LORAWAN_REV2_LOW_LEVEL_Private_Functions
  * @{
  */ 
  /**
  * @}
  */
/**
  * @brief  This method returns the INRPO_LORAWAN_REV2 BSP Driver revision
  * @param  None
